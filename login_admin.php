...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/icons/logo_upr.png"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" src="images/logo_upr_baru.png">
			<div class="wrap-login100 p-t-90 p-b-30">
				<form class="login100-form validate-form" action="cek_login.php" method="post">
					...
					<div style=" width: 150px; height: 150px; border-radius: 50%; margin: 0 auto;">
						<img style="width: 100%;" src="images/logo_upr_baru.png" alt="AVATAR">
					</div>

					<span style="font-size: 19px" class="login100-form-title p-b-45">
						</br>SHOPEE</br>EXPEDITION</br>
					</span>
